...
public class AuthenticationFilter implements Filter {
	...
	public void doFilter(javax.servlet.ServletRequest request,
		...
		try {
			...
			String contextPath = ((HttpServletRequest) request)
					.getContextPath();
			String initialHTTPRequest = ((HttpServletRequest) request)
			...
			try {
				sessionContainerWO = (be.dpms.medwan.webapp.wo.common.system.SessionContainerWO) SessionContainerFactory
						.getInstance().getSessionContainerWO(
								(HttpServletRequest) request,
								SessionContainerWO.class.getName());
			...
			request.getRequestDispatcher(IConstants.MEDWAN_LOGIN_PAGE).forward(
					request, response);
	...
	private void verifyAuthentication(ServletRequest request)
			throws AuthenticationRequiredException,
			SessionContainerFactoryException {
		SessionContainerWO sessionContainerWO = (SessionContainerWO) SessionContainerFactory
				.getInstance().getSessionContainerWO(
						(HttpServletRequest) request,
						SessionContainerWO.class.getName());
