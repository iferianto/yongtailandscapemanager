...
;
	...
	<body>
		<div class="x" panelTitle="用户信息" showStatus="false">
			<table width="95%">
				<tr>
					<s:form action="user!listjingqu.action">
						<td>
							用户名：
				...
				<tr>
					<td colspan="7">
						<input type='button' value='新增景区用户'
							onclick="doPermission({'url':'/system/user!addPageJinqu.action','opeCount':'0','msgBoxType':'1'})" /> 
						<input type='button' value='修改'
							onclick="doPermission({'url':'/system/user!editPage.action','opeCount':'1','msgBoxType':'1'})" />
						<input type='button' value='删除'
							onclick="doPermission({'url':'/system/user!deletejingqu.action','opeCount':'2','msgBoxType':'2'})" />
				...
				<form id="list_entity_form" name="list_entity_form" method="post">
					...
					<c:forEach items="${page.result}" var="item">
						<tr>
							...
							<td>
								<fmt:formatDate value="${item.lastLoginTime}"
