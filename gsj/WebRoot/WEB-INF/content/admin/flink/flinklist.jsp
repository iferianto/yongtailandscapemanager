...
;
	...
	<body>
		<div class="box2" panelTitle="友情链接" roller="false"
			showStatus="false">
			<table width="95%">
				<tr>
				...
				<tr>
					<td colspan="7">
						<input type='button' value='新增'
							onclick="doPermission({'url':'/admin/flink!addPage.action','opeCount':'0','msgBoxType':'1'})" />
						<input type='button' value='修改'
							onclick="doPermission({'url':'/admin/flink!editPage.action','opeCount':'1','msgBoxType':'1'})" />
						<input type='button' value='删除'
							onclick="doPermission({'url':'/admin/flink!delete.action','opeCount':'2','msgBoxType':'2'})" />
					</td>
				</tr>
			</table>
			<div>
