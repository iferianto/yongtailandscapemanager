...
$().ready(function() {
	...
	<body>
		<div id="scrollContent">
			<s:form action="xcfq!save.action" id="form1">
				<div class="box2" panelWidth="100%" panelTitle="巡查反馈"
					...
					<table width="95%" class="tableStyle">
						...
						<tr>
							...
							<td>
								<s:textfield name="xcfq.occerdate" maxlength="15"	onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd'})"  readonly="true"></s:textfield>
							</td>
						</tr>
						<tr>
							<td width="15%" align="right">
...
<%--							</td>--%>
<%--							<td width="35%">--%>
<%--								<s:textfield name="xcfq.zf" maxlength="2" readonly="true"></s:textfield>--%>
<%--							</td>--%>
<%----%>
<%--							<td width="15%" align="right">--%>
<%--								平均分：--%>
<%--							</td>--%>
<%--							<td>--%>
<%--								<s:textfield name="xcfq.pjf" maxlength="15" readonly="true"></s:textfield>--%>
<%--							</td>--%>
<%--						</tr>--%>
						<c:forEach items="${options}" var="item" varStatus="i">
							...
							<td width="35%">
<%--								<input name="option_${item.id}" maxlength="5" type="text"></input>(请输入数字)--%>
									<select name="option_${item.id}" class="default">
										<option value="100" >否</option>
